(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='index.html' class='logo-mobile-menu'><img src='img/logo.png' /></a><a href='#' class='logo-mobile-menu1'><i class='fa fa-shopping-bag' ></i></a><a href='#' class='logo-mobile-menu2'><i class='fa fa-search' ></i></a>" });
