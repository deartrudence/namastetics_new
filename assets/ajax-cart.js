...
var ajaxCart = (function(module, $) {
  ...
  // Private functions
  var updateCountPrice, formOverride, itemAddedCallback, itemErrorCallback, removeButtonCall, cartUpdateCallback, buildCart, cartCallback, adjustCart, adjustCartCallback, createQtySelectors, qtySelectors, validateQty;
...
// var item_variant_id = product.variant_id;
//     alert(item_variant_id);
    ShopifyAPI.getCart(cartUpdateCallback);
  };
  ...
  $("#crt").on('click', "a.remove_item", function(){
    ...
    var id = $(this).data("id");
    ShopifyAPI.changeItem(id,0, function(cart){
      
      if(!cart.item_count) {
        $("#crt").html("").append('<p class="empty-cart">' + "Your cart is currently empty." + '</p>');
      $('#CartCount').hide();
      }
      else {
    ...
    $.each(cart.items, function(index, cartItem) {
      ...
      */
      ...
      item = {
        ...
        variation_id: cartItem.variant_id,
